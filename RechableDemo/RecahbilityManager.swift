...
public class Reachability {
    ...
    fileprivate(set) var flags: SCNetworkReachabilityFlags? {
        didSet {
            ...
            reachabilityChanged()
            let wifiName = ["wifiName": getSSID() ?? ""]
            NotificationCenter.default.post(name: Notification.Name("rechabilityChanged"), object: nil, userInfo: wifiName as [AnyHashable : Any])
        }
    }
